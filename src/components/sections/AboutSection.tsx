    ...
    >
      ...
      <div className="container relative flex flex-col items-center justify-center min-h-[calc(105vh-220px)] px-4" style={{ zIndex: Z_INDEX.CONTENT }}>
        ...
        <div className="w-full max-w-4xl mx-auto rounded-2xl border border-white/40 bg-white/30 p-4 sm:p-6 md:p-8 text-black shadow-lg backdrop-blur supports-[backdrop-filter]:bg-white/25 mb-6 md:mb-8">
          <h1 className="text-xl sm:text-2xl md:text-3xl font-gotham-bold mb-4 md:mb-6 text-left">
            Metodología Potencia
          </h1>
          <div className="text-left space-y-3 md:space-y-4">
            <p className="text-sm sm:text-base leading-relaxed font-gotham-book">
        ...
        <button className="w-full max-w-xs rounded-full border border-white/40 bg-white/30 px-6 py-3 text-sm sm:text-base text-black shadow-lg backdrop-blur supports-[backdrop-filter]:bg-white/25 hover:bg-white/40 transition-all duration-300 font-gotham-book">
          ver más
        </button>
      </div>
