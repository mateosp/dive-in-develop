...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section
        id="inicio"
        className={`fixed inset-0 w-full h-screen overflow-hidden bg-cover bg-center section-transition ${
      ...
      >
        ...
        <div className="container relative z-30 flex items-center justify-center min-h-[calc(90vh-200px)]">
          <div className="max-w-xl text-left hero-text">
            <h1 className="text-4xl font-semibold sm:text-5xl lg:text-6xl animate-fade-in-up">
      ...
      >
        ...
        <div className="container relative z-30 flex flex-col items-center justify-center min-h-[calc(105vh-200px)]">
          {/* Content Box */}
          <div className="w-[60%] rounded-2xl glass-effect p-8 text-text-on-glass shadow-glass mb-8">
          ...
          {/* Ver Más Button */}
          <button className="rounded-full glass-effect px-6 py-3 text-text-on-glass shadow-glass hover:bg-white/40 transition-all duration-300">
            ver más
          </button>
        </div>
